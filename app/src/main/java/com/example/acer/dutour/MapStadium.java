...
public class MapStadium extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_stadium);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addPolyline(new PolylineOptions().add(
                ...
                new LatLng(30.266432, 78.045919),
                Sport
        )
                .width(10)
                .color(Color.RED));
