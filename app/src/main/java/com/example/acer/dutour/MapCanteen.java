...
public class MapCanteen extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_canteen);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addPolyline(new PolylineOptions().add(
                ...
                new LatLng(30.268623, 78.046517),
                new LatLng(30.269201, 78.046502),
                canteen
        )
                .width(10)
                .color(Color.RED));
