...
public class MapsBhostel extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_bhostel);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addPolyline(new PolylineOptions().add(
                ...
                new LatLng(30.268808, 78.045934),
                bhos
        )
                .width(10)
                .color(Color.RED));
