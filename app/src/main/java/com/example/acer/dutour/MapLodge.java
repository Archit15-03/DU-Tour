...
public class MapLodge extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_lodge);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addPolyline(new PolylineOptions().add(
                ...
                new LatLng(30.269232, 78.044351),
                new LatLng(30.269073, 78.044461),
                new LatLng(30.269016, 78.045210),
                new LatLng(30.268906, 78.045324),
                new LatLng(30.268944, 78.045504),
                new LatLng(30.268478, 78.046819),
                new LatLng(30.268042, 78.047210),
                new LatLng(30.267263, 78.047111),
                new LatLng(30.266712, 78.046949),
                new LatLng(30.266393, 78.045256),
                new LatLng(30.266240, 78.045089),
                new LatLng(30.264890, 78.044741),
                Lodge
        )
                .width(10)
                .color(Color.RED));
