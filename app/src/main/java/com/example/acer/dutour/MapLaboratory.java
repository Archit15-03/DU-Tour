...
public class MapLaboratory extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_laboratory);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addPolyline(new PolylineOptions().add(
                ...
                new LatLng(30.266792, 78.046256),
                Lab
        )
                .width(10)
                .color(Color.RED));
